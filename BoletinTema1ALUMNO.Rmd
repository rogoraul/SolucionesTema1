...
```{r}
setdiff(mam,ani) # Todos los animales de mam estan en ani
setdiff(ani,mam) # Hay 3 animales en ani que no estan en mam, son unos pequeños animalitos, dinosaurios
